    ...
    <View style={[styles.container, { backgroundColor: c.background }]}>
      ...
      <View style={styles.illustrationContainer}>
        ...
        <View style={[styles.mainGlassCard, { backgroundColor: isDark ? 'rgba(31,31,31,0.4)' : c.card, borderColor: c.cardGlassBorder }]}>
          <View style={[styles.centerIconWrap, { backgroundColor: isDark ? 'rgba(52,199,89,0.26)' : c.accentSoft, borderColor: c.primary + '60' }]}>
            <Ionicons name="medkit-outline" size={38} color={c.primary} />
          </View>
      ...
      <View style={styles.bottomContent}>
        <Text style={[styles.emptySubtitle, { color: c.textSecondary }]}>
          Keep track of your surgical history for quick access during emergencies
        </Text>
        <TouchableOpacity
        ...
        >
          ...
          <Text style={[styles.addButtonText, { color: c.textOnPrimary }]}>Add Surgical Record</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
