    ...
    <View style={[styles.container, { backgroundColor: c.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent, { paddingTop: insets.top + 16, paddingBottom: 120 }]} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: c.text, fontFamily: 'Inter' }]}>Vaccinations</Text>
          <View style={{ width: 24 }} />
        </View>

        <View style={styles.heroSection}>
          <Text style={[styles.heroTitle, { color: c.text, fontFamily: 'Inter' }]}>New Vaccination</Text>
          <Text style={[styles.heroSubtitle, { color: c.textSecondary, fontFamily: 'Inter' }]}>Add your vaccination record to keep{'\n'}your immunization history organized.</Text>
        </View>

        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>VACCINE NAME</Text>
        <View style={[styles.inputWrap, { backgroundColor: c.inputBackground, borderColor: c.inputBorder }]}>
          <TextInput style={[styles.input, { color: c.text, fontFamily: 'Inter' }]} placeholder="e.g. COVID-19 Booster" placeholderTextColor={c.inputPlaceholder} value={vaccineName} onChangeText={setVaccineName} />
        </View>

        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>DATE OF VACCINATION (OPTIONAL)</Text>
        ...
        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>DOSE NUMBER</Text>
        <TouchableOpacity style={[styles.inputWrap, { backgroundColor: c.inputBackground, borderColor: c.inputBorder }]}>
          <View style={styles.inputWithIcon}>
            <View style={[styles.inputIconWrap, { backgroundColor: c.accentSoft }]}><Ionicons name="medkit-outline" size={12} color={c.primary} /></View>
            <Text style={[styles.inputPlaceholder, { color: c.inputPlaceholder, fontFamily: 'Inter' }]}>Select Dose</Text>
          </View>
        </TouchableOpacity>

        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>NEXT DUE DATE (OPTIONAL)</Text>
        <TouchableOpacity style={[styles.inputWrap, { backgroundColor: c.inputBackground, borderColor: c.inputBorder }]}>
          <View style={styles.inputWithIcon}>
            <View style={[styles.inputIconWrap, { backgroundColor: c.accentSoft }]}><Ionicons name="calendar-outline" size={12} color={c.primary} /></View>
            <Text style={[styles.inputPlaceholder, { color: c.inputPlaceholder, fontFamily: 'Inter' }]}>Select Date</Text>
        ...
        <TouchableOpacity style={[styles.uploadArea, { borderColor: c.cardGlassBorder, backgroundColor: c.card }]} activeOpacity={0.7} onPress={() => setShowUploadModal(true)}>
          ...
          <Text style={[styles.uploadTitle, { color: c.text, fontFamily: 'Inter' }]}>Upload certificate</Text>
        ...
        <TouchableOpacity style={[styles.addBtn, { backgroundColor: c.accentSoft }]} onPress={() => navigation.goBack()}>
          ...
          <Text style={[styles.addBtnText, { color: c.primary, fontFamily: 'Inter' }]}>Add Vaccination Record</Text>
        </TouchableOpacity>
      </ScrollView>
      ...
      <Modal visible={showUploadModal} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={[styles.uploadModal, { backgroundColor: c.modal, borderColor: c.cardGlassBorder }]}>
            ...
            <Text style={[styles.modalTitle, { color: c.text, fontFamily: 'Inter' }]}>Choose how you'd like to upload</Text>
