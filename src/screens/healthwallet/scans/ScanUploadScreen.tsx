    ...
    <View style={[styles.container, { backgroundColor: c.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent, { paddingTop: insets.top + 16, paddingBottom: 120 }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroSection}>
          <Text style={[styles.heroTitle, { color: c.text, fontFamily: 'Inter' }]}>New Scan</Text>
          <Text style={[styles.heroSubtitle, { color: c.textSecondary, fontFamily: 'Inter' }]}>Upload your scan to keep your records{'\n'}organized and accessible.</Text>
        </View>

        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>NAME OF THE SCAN</Text>
        <View style={[styles.inputWrap, { backgroundColor: c.inputBackground, borderColor: c.inputBorder }]}>
          <TextInput style={[styles.input, { color: c.text, fontFamily: 'Inter' }]} placeholder="e.g. MRI Brain" placeholderTextColor={c.inputPlaceholder} value={scanName} onChangeText={setScanName} />
        </View>

        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>DATE OF SCAN (OPTIONAL)</Text>
        ...
        <Text style={[styles.sectionLabel, { color: c.textSecondary, fontFamily: 'Inter' }]}>SCAN TYPE</Text>
        <TouchableOpacity style={[styles.inputWrap, { backgroundColor: c.inputBackground, borderColor: c.inputBorder }]}>
          <View style={styles.inputWithIcon}>
            <View style={[styles.inputIconWrap, { backgroundColor: c.accentSoft }]}><Ionicons name="scan-outline" size={12} color={c.primary} /></View>
            <Text style={[styles.inputPlaceholder, { color: c.inputPlaceholder, fontFamily: 'Inter' }]}>Select Type</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={[styles.uploadArea, { borderColor: c.cardGlassBorder, backgroundColor: c.card }]} activeOpacity={0.7} onPress={() => setShowUploadModal(true)}>
          ...
          <Text style={[styles.uploadTitle, { color: c.text, fontFamily: 'Inter' }]}>Upload your scan files</Text>
        ...
        <TouchableOpacity style={[styles.addBtn, { backgroundColor: c.accentSoft }]} onPress={() => navigation.goBack()}>
          ...
          <Text style={[styles.addBtnText, { color: c.primary, fontFamily: 'Inter' }]}>Add to Scans</Text>
        </TouchableOpacity>
      </ScrollView>
