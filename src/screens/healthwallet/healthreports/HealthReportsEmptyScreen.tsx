        ...
        <View style={styles.illustrationArea}>
          <View style={[styles.mainGlassCircle, { backgroundColor: c.cardElevated, borderColor: c.cardGlassBorder }]}>
            ...
            <View style={[styles.floatingCard, styles.floatingCardBottomLeft, { backgroundColor: c.cardElevated, borderColor: c.cardGlassBorder }]}>
              <Ionicons name="pulse-outline" size={14} color={c.textSecondary} />
            </View>
          </View>
        </View>
        <Text style={[styles.emptyTitle, { color: c.text, fontFamily: 'Inter' }]}>No Health{'\n'}Reports Found</Text>
        <Text style={[styles.emptySubtitle, { color: c.textSecondary, fontFamily: 'Inter' }]}>
          Your medical reports archive is ready.{'\n'}Add your first report to start tracking
        </Text>
        <TouchableOpacity style={[styles.addButton, { backgroundColor: c.accentSoft }]} activeOpacity={0.7} onPress={() => navigation.navigate('HealthReportUpload')}>
